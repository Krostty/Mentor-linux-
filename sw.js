...
const VERSION = 'mentor-linux-v14-pedagogia';
...
const RECURSOS = [
  ...
  'js/engine/commands/python.js',
  'js/engine/commands/web.js',
  'js/data/modules.js',
  ...
  'js/data/salas.js',
  'js/data/piezas.js',
  'js/data/curriculum-v2.js',
  'js/data/pedagogia.js',
  'js/data/salas-redes.js',
  'js/data/salas-redes-cero.js',
  'js/data/salas-redes-profundas.js',
  'js/data/salas-fundamentos.js',
  'js/data/salas-linux-internals.js',
  'js/data/salas-programacion.js',
  'js/data/salas-web.js',
