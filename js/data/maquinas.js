...
export const MAQUINAS = MACHINE_SEEDS.map((seed, i) => {
  ...
  return {
    ...
    alcance: [p.ip, p.host],
    fueraDeAlcance: ['Internet real', 'otros hosts o redes', 'persistencia fuera del laboratorio'],
    roe: [
      'Trabajar únicamente dentro del simulador local.',
      'No ampliar el alcance aunque aparezca otro objetivo.',
      'Conservar comandos y salida como evidencia reproducible.',
      'Documentar impacto y remediación sin ocultar acciones.',
    ],
