  ...
  tareas: [
    {
      ...
      pasos: [
        ...
        {
          tipo: 'imagen', src: 'assets/teoria/redes/viaje-paquete.png', width: 960, height: 640,
          alt: 'Un paquete viaja desde un equipo de la red local al gateway, Internet y un servidor.',
          caption: 'El equipo no salta directamente al servidor: entrega el paquete a `192.168.1.1`, su gateway y siguiente salto.',
        },
        { tipo: 'ejercicio', ejercicioId: 'rc-q1' },
        { tipo: 'teoria', indice: 1 },
        { tipo: 'ejercicio', ejercicioId: 'rc-q2' },
        { tipo: 'teoria', indice: 2 },
        { tipo: 'ejercicio', ejercicioId: 'rc-q3' },
        { tipo: 'teoria', indice: 3 },
        { tipo: 'ejercicio', ejercicioId: 'rc-ver-ip' },
        { tipo: 'ejercicio', ejercicioId: 'rc-r1' },
        { tipo: 'teoria', indice: 4 },
        { tipo: 'ejercicio', ejercicioId: 'rc-ver-gw' },
        { tipo: 'ejercicio', ejercicioId: 'rc-r2' },
        { tipo: 'ejercicio', ejercicioId: 'rc-c1' },
      ],
    },
    {
